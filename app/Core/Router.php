...
final class Router
{
    ...
    public static function routes(): array
    {
        return [
            ...
            'returns' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'index', 'http' => ['GET'], 'roles' => ['admin', 'reception', 'nurse', 'doctor']],
            'return.form' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'form', 'http' => ['GET'], 'roles' => ['admin', 'reception', 'nurse', 'doctor']],
            'return.save' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'save', 'http' => ['POST'], 'roles' => ['admin', 'reception', 'nurse', 'doctor']],
            'return.schedule.form' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'scheduleForm', 'http' => ['GET'], 'roles' => ['admin', 'reception']],
            'return.schedule' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'schedule', 'http' => ['POST'], 'roles' => ['admin', 'reception']],
            'return.status' => ['class' => \App\Controllers\ReturnController::class, 'method' => 'updateStatus', 'http' => ['POST'], 'roles' => ['admin', 'reception', 'nurse', 'doctor']],
            ...
            'admin.panel.save' => ['class' => \App\Controllers\AdminController::class, 'method' => 'panelSettingsSave', 'http' => ['POST'], 'roles' => ['admin']],
            ...
            'queue.call.next' => ['class' => \App\Controllers\QueueController::class, 'method' => 'callNext', 'http' => ['POST'], 'roles' => ['admin', 'reception', 'nurse', 'doctor']],
